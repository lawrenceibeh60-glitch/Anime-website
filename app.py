...
def status():
    ...
    return jsonify({"animeheaven": "connected" if ah_ok else "disconnected", "anilist": "connected" if anilist_ok else "disconnected", "groq": "connected" if GROQ_API_KEY else "no_key"})
